...
@section('title', __('View All Questions') )
...
@section('pageinfo')
          ...
          <div >
            ...
            <h4 class="mg-b-0 tx-spacing--1">{{ __('View All Questions') }}</h4>
          </div>
...
@section('content')
  ...
  <div class="col-lg-12">
    <!-- <div class="col-sm-12 col-lg-3 float-right mb-4">
      ...
      <table style="width:100%" class="table table-striped list-all-questions" id="example">
