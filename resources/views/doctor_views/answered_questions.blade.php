    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active">
                    <a href="#"><i class="menu-icon fa fa-check"></i>
Answered Questions</a>
                ...
                <li>
                    <a href="<?php echo Config::get('constants.USER_APP_DIRECTORY'); ?>/doctor/logout"><i class="menu-icon fa fa-power-off text-danger"></i>
Sign Out </a>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
