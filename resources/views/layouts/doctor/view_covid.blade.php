          ...
          <div >
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                ...
                <li class="breadcrumb-item cs-active" aria-current="page">{{ __('Rumor Tool') }}</li>
              </ol>
            </nav>
            <h4 class="mg-b-0 tx-spacing--1">{{ __('Rumor Tool') }}</h4>
          </div>
...
@section('content')
  ...
  <div class="col-lg-12">
    <!-- <div class="col-sm-12 col-lg-3 float-right mb-4">
      ...
      <table style="width:100%" class="table table-striped workflow-items" id="example">
...
@section('javascript')
     <script src="{{ asset('../../assets/js/doctor/coviddata.js') }}"></script>
     <script>
