        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown active-list">
                    <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-question-circle-o"></i>Questions</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li class="active"><i class="menu-icon fa fa-list-ul"></i><a href="#">Ques. Categories</a></li>
...
<div id="right-panel" class="right-panel">
    ...
    <div class="content">
        ...
        <div class="btn btn-float rounded-circle pulse" data-target="#add-question-category-modal" data-toggle="modal">+</div>
    </div>

    <!-- Add question-category modal -->
    <div class="modal fade" id="add-question-category-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="add-question-category-form">
                    <div class="form-group">
                        <label><small>Question Category Name:</small></label>
                        <input type="text" class="form-control form-control-sm add-question-category-name">
                    </div>
            </div>
        ...
        <!-- Edit question-category modal -->
        <div class="modal fade" id="edit-question-category-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Question Category</h5>
                </div>
                <div class="modal-body">
                    <form class="edit-question-category-form">
                        <input type="hidden" name="" class="edit-question-category-id">
                        <div class="form-group">
                            <label><small>Question Category Name:</small></label>
                            <input type="text" class="form-control form-control-sm edit-question-category-name">
                        </div>
                </div>
                <div class="modal-footer">
...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ asset('js/controllers/admin/admin-question-controller.js') }}"></script>
    <script>
