...
@section('content')
        ...
        <div class="ht-100p d-flex flex-column align-items-center justify-content-center">
					<h5 class="tx-20 tx-sm-24">{{ __('A password reset link has been sent to your email')  }}</h5>
        		<!-- <p class="tx-color-03 mg-b-40">Enter your email address and we will send you a link to reset your password.</p> -->
          <div class="wd-150 wd-sm-250 10 mg-b-10">

						<a href="/forgotten-password" style="color:#fff !important;" class="btn btn-block bg-site-primary border-site-primary">
...
<!--
          	...
          	<div class="row row-sm mg-b-5 ">
        	   <div class="form-group col-sm-10">
                <input type="email" name="email" id="user-email" class="form-control" placeholder="Enter your email">
              </div>
            </div>
					</form> -->
