              ...
              <div class="row">
                <div class="col-sm-6 col-md-6 col-lg">
                  <div class="avatar avatar-xxl avatar-online">
                    @if(isset($doctorDetails->thumbnail)  && $doctorDetails->thumbnail != '' && $doctorDetails->thumbnail != 'n_a' && $doctorDetails->thumbnail != 'n/a')

                    <img src="{{ $doctorDetails->thumbnail }}" alt="Update Profile Image" class="rounded-circle" alt="">
                      @else
                ...
                <div class="col-sm-12 col-md-12 col-lg mg-t-20 mg-sm-t-0 mg-lg-t-25">
                  <h5 class="mg-b-2 tx-spacing--1"> {{ $doctorDetails->first_name }} {{ $doctorDetails->last_name }}</h5>
                 <!--  <p class="tx-color-03 mg-b-25">@fenchiumao</p> -->

                  <div class="col-sm-12 mg-b-25">
                    <button data-toggle="modal" data-target="#modalFileAttachment" class="btn btn-block btn-xs btn-white flex-fill">
                    {{ __('Update Image')  }}</button>

                    <button data-toggle="modal" data-target="#modalChangePassword" class="btn btn-block btn-xs btn-secondary flex-fill">
                ...
                <div class="card-body pd-25">
                  ...
                  <div class="row row-sm mg-b-10 mt-3 pl-4">
                   <div class="form-group col-md-8">
                      ...
                      <input type="text" value="{{ $doctorDetails->first_name }}" class="form-control" name="first_name">
                   </div>

                     <div class="form-group col-md-8">
                      <label>{{ __('Last Name') }}</label>
                      <input type="text" value="{{ $doctorDetails->last_name }}" class="form-control" name="last_name">
                   </div>
                 </div>
                 ...
                 <div class="row row-sm mg-b-10 mt-3 pl-4">
                   <div class="form-group col-md-8">
                      ...
                      <input type="text" readonly="" value="{{ $doctorDetails->username }}" class="form-control" name="username">
                   </div>

                   <div class="form-group col-md-8">
                      <label>{{ __('Email') }}</label>
                      <input type="text" value="{{ $doctorDetails->email }}" class="form-control" name="email">
                   </div>
                     ...
                     <div class="form-group col-md-8">
                      ...
                      <input type="text" value="{{ $doctorDetails->phone }}" class="form-control" name="phone">
                   </div>
                    ...
                    <div class="row row-sm mg-b-10 mt-3 pl-4">
                         ...
                         <div class="form-group col-md-8">
                            ...
                            <input type="text" value="{{ $doctorDetails->gender }}" class="form-control" name="gender">
                         </div>
                         ...
                         <div class="form-group col-md-8">
                            ...
                            <select name="country" class="form-control">
                              ...
                              <option value="{{ $doctorDetails->country }}">{{ $doctorDetails->country }}</option>
                              <option value=""></option>
                      ...
                      <textarea  name="address" class="form-control">{{ $doctorDetails->address }}</textarea>
                      </div>

                      <div class="form-group col-md-8">
                      <label>{{ __('Bio') }}</label>
                      <textarea  name="bio" class="form-control">{{ $doctorDetails->bio }}</textarea>
                      </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-body pd-20 pd-sm-30">
            ...
            <input type="hidden" id="target-user"  name="target_question" value="{{ $doctorDetails->doctor_id }}">
            ...
            <h6 class="tx-18 tx-sm-20 mg-b-5">{{ __('Change Password') }}</h6>
                        ...
                        <div class="form-group col-md-12">
                         ...
                         <div class="form-group col-md-12">
                            ...
                            <input type="password" id="new-password"  class="form-control" placeholder="password" name="password">
                         </div>
                         ...
                         <div class="form-group col-md-12">
                           ...
                           <div class="form-group col-md-12">
                              <button type="button" class="btn btn-secondary btn-block sesa" type="button" id="button-addon2"> 
                              {{ __('Change') }} </button>
                         </div>
