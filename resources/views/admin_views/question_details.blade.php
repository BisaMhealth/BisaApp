            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown active-list">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li class="active"><i class="menu-icon fa fa-question"></i><a href="<?php echo Config::get('constants.ADMIN_APP_DIRECTORY'); ?>/admin/questions">All Questions</a></li>
                    </ul>
                </li>
...
<div id="right-panel" class="right-panel">
    ...
    <div class="content">
        <h5 class="text-center question-details-title"></h5><br>
        <div class="row">
            <div class="col-md-12 questions-details-res"></div>
        </div>
    </div>
