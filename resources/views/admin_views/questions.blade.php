            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown active-list">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li class="active"><i class="menu-icon fa fa-question"></i><a href="#">All Questions</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="menu-icon fa fa-user-md"></i><a href="<?php echo Config::get('constants.ADMIN_APP_DIRECTORY'); ?>/admindoctors-accounts">Doctors</a></li>
...
<div id="right-panel" class="right-panel">
    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12 questions-res"></div>
        </div>
    </div>
...
@section('javascript')
    <script src="{{ asset('js/admin-constants.js') }}"></script>
